$PROB ABS ONE COMP PKPD INDIRECT RESPONSE (STIMULATION OF RESPONSE ELIMINATION) MODEL
...
ETA_EC50    : 0 0 0 0 0 0 0 0.01 : ETA on EC50
ETA_EMAX    : 0 0 0 0 0 0 0 0 0.01 : ETA on EMAX  
...
dxdt_RESP = KINi - KOUTi*(1+STIM)*RESP;
